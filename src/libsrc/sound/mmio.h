//'EI'£A‰OyxO Eugene Olafsen(AA)æE™o'MFC Programming with Visual C++ 6 Unleashed' 
//May.8 
//----------------------------------------------------------------- 
// MMIO Objects 
// C++ Header - MMIO.h 
...
public: 
  ...
  // Public Methods 
public: 
  void      Open(const char* pszFileName, DWORD dwOpenFlags = MMIO_READ);
...
inline void CMMIO::Open(const char* pszFileName, DWORD dwOpenFlags)
{
