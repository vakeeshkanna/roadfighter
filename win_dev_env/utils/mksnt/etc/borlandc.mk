# MKS MAKE default rules for Borland C++ 3.00 and 3.1 compilers on DOS
...
# Command names
CC	:= bcc			# Borland C++
LD	:= bcc			# Interface to TLINK
AS	:= tasm			# Turbo Assembler
...
ASFLAGS=
COFLAGS=-q			# check-out
LDFLAGS=$(CFLAGS)		# same as CFLAGS with bcc interface to TLINK
...
# Use bcc as interface to TLINK
%$E: %$O;	$(LD) $(LDFLAGS) -e$@ $& $(LDLIBS)
%$E:	;	$(LD) $(LDFLAGS) -e$@ $& $(LDLIBS)
